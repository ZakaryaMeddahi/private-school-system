...
const Footer = () => {
    return (
        <Container w='100%' h='500px' maxW='100%' paddingBlock='20px' paddingInline='50px' bgColor='#F1F2ED' color='#898C81' > 
            <Grid maxW='100%' height='80%' templateColumns='repeat(12, 1fr)' gap='10' p='15' alignContent='center' justifyItems='center' alignItems='center'>
                <GridItem colSpan={6}>
                    ...
                    <Text fontSize='16px' marginBlock='20px' marginLeft='30px' width='450px'>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla quam velit, vulputate eu pharetra nec, mattis ac neque. Duis vulputate commodo lectus, ac blandit elit tincidunt id.
                    </Text>
                </GridItem>
                <GridItem colSpan={2}>
                    <FooterList title='Links' children={[<Item item='Home' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='About' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='courses' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='Contact' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />]} />
                </GridItem>
                <GridItem colSpan={2}>
                    <FooterList title='Courses' children={[<Item item='Web Development' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='Mobile Development' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='Data Science' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='Artificial Intelligence' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />]} />
                </GridItem>
                <GridItem colSpan={2}>
                    <FooterList title='Contact' children={[<Item item='Address: 1234 Street Name, City Name, United States' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='Phone: +123 456 789' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />, <Item item='Email: ex@gmail.com' color='gray' _hover={{color: '#213E69'}} transition='all 0.6s ease' />]} />
                </GridItem>
            </Grid>
