...
const StudentsPage = () => {
    ...
    const SearchStudent = (value) => {
        const newStudents = [];
        Students.filter((student) => {
            if(student.firstName.toLowerCase().includes(value.toLowerCase()) || student.lastName.toLowerCase().includes(value.toLowerCase())) {
                newStudents.push(student);
            }
        })
        setStudents(newStudents);
                                ...
                                >
                                    ...
                                    >
                                        <Box
                                            ...
                                            borderRadius={'50%'}
                                        >
                                            <Text fontSize={18} fontWeight={500}>{student.firstName[0]}</Text>
                                        </Box>
                                        <Box
                                            display='flex'
                                            ...
                                            justifyContent='center'
                                        >
                                            <Text fontSize={18} fontWeight={500}>{`${student.firstName} ${student.lastName}`}</Text>
                                        </Box>
                                    </Box>
                                    <Box
                                        display='flex'
